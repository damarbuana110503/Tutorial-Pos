...
class BarangController extends Controller
{
    ...
    public function store(Request $request)
    {
        $this->validate($request, [
            'kode_barang' => 'required|string|max:5|unique:barangs,FK_BRG',
            ...
            'max' => 'Maksimum Angka yang Di-input tidak boleh lebih dari :max karakter !',
    ...
    {
        $this->validate($request, [
            'kode_barang' => 'required|string|max:5|unique:barangs,FK_BRG,' . $id . ',FK_BRG',
            'nama_barang' => 'required|string',
            'jenis_barang' => 'required|string|exists:jenis,FK_JENIS',
            'satuan_barang' => 'required|string|exists:satuans,FK_SAT',
            'harga_hna' => 'required|numeric|min:0',
